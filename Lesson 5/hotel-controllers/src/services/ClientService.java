...
public class ClientService implements IClientService {
    ...
    public void settleClientInRoom(int clientId, int roomId) {
        ...
        if (new RoomRepository().findById(roomId).getFree() && !new RoomRepository().findById(roomId).getRepair()){
            clientRepository.findById(clientId).setRoom(new RoomRepository().findById(roomId));
